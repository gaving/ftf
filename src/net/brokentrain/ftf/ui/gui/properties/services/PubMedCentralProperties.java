...
public class PubMedCentralProperties extends PropertyPage {

    private static final int MIN_RESULTS = 1;

    private static final int MAX_RESULTS = 10;

    private static final String SERVICE_ENTRY = "PubMedCentral";
    ...
    public PubMedCentralProperties(Composite parent) {
        super(parent);
    }
    ...
    public void applyButtonPressed() {
        ...
        services.put(PubMedCentralProperties.SERVICE_ENTRY, serviceEntry);
    ...
    protected void initComponents() {
        ...
        serviceEntry = services.get(PubMedCentralProperties.SERVICE_ENTRY);
