...
public class TerrierProperties extends PropertyPage {

    private static final int MIN_RESULTS = 1;

    private static final int MAX_RESULTS = 30;

    private static final String SERVICE_ENTRY = "Terrier";
    ...
    public TerrierProperties(Composite parent) {
        super(parent);
    }
    ...
    public void applyButtonPressed() {
        ...
        services.put(TerrierProperties.SERVICE_ENTRY, serviceEntry);
    ...
    protected void initComponents() {
        ...
        serviceEntry = services.get(TerrierProperties.SERVICE_ENTRY);
