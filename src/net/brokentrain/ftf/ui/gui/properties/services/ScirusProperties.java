...
public class ScirusProperties extends PropertyPage {

    private static final int MIN_RESULTS = 1;

    private static final int MAX_RESULTS = 10;

    private static final String SERVICE_ENTRY = "Scirus";
    ...
    public ScirusProperties(Composite parent) {
        super(parent);
    }
    ...
    public void applyButtonPressed() {
        ...
        services.put(ScirusProperties.SERVICE_ENTRY, serviceEntry);
    ...
    protected void initComponents() {
        ...
        serviceEntry = services.get(ScirusProperties.SERVICE_ENTRY);
