...
public class WebOfKnowledgeProperties extends PropertyPage {

    private static final int MIN_RESULTS = 1;

    private static final int MAX_RESULTS = 10;

    private static final String SERVICE_ENTRY = "WebOfKnowledge";
    ...
    public WebOfKnowledgeProperties(Composite parent) {
        super(parent);
    }
    ...
    public void applyButtonPressed() {
        ...
        services.put(WebOfKnowledgeProperties.SERVICE_ENTRY, serviceEntry);
    ...
    protected void initComponents() {
        ...
        serviceEntry = services.get(WebOfKnowledgeProperties.SERVICE_ENTRY);
