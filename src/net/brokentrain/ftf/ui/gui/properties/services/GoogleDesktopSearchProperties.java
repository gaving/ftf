...
public class GoogleDesktopSearchProperties extends PropertyPage {

    private static final int MIN_RESULTS = 1;

    private static final int MAX_RESULTS = 30;

    private static final String SERVICE_ENTRY = "GoogleDesktopSearch";
    ...
    public GoogleDesktopSearchProperties(Composite parent) {
        super(parent);
    }
    ...
    public void applyButtonPressed() {
        ...
        services.put(GoogleDesktopSearchProperties.SERVICE_ENTRY, serviceEntry);
    ...
    protected void initComponents() {
        ...
        serviceEntry = services
                .get(GoogleDesktopSearchProperties.SERVICE_ENTRY);
