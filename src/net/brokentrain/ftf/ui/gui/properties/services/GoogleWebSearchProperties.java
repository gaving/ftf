...
public class GoogleWebSearchProperties extends PropertyPage {

    private static final int MIN_RESULTS = 1;

    private static final int MAX_RESULTS = 10;

    private static final String SERVICE_ENTRY = "GoogleWebSearch";
    ...
    public GoogleWebSearchProperties(Composite parent) {
        super(parent);
    }
    ...
    public void applyButtonPressed() {
        ...
        services.put(GoogleWebSearchProperties.SERVICE_ENTRY, serviceEntry);
    ...
    protected void initComponents() {
        ...
        serviceEntry = services.get(GoogleWebSearchProperties.SERVICE_ENTRY);
